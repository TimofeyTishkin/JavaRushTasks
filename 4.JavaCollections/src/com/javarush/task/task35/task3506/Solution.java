...
public class Solution {
    ...
    public static <D1> void add(List<? super D1> destinationList, List<? extends D1> sourceList) {
        ListIterator<? super D1> destListIterator = destinationList.listIterator();
        ListIterator<? extends D1> srcListIterator = sourceList.listIterator();
